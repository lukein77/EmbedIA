...
print('Bienvenido a la generación del futuro.')
...
if DATASET_COUNT > 0 and DATASET_COUNT <= data_class.shape[0]:
...
try:
    ...
    for i in range(len(data_test)):
        ...
        test_image = str(list(data_test[i].transpose(2,0,1).flatten()))
        ...
        # clase_imagen = str(data_class[i][0])
        ...
        print(resp)
        print("Clase %5s == %2s - us: %5s - out: %2s  \t%s" % (clase_imagen, clase_inferida, tiempo, confianza, ok))
